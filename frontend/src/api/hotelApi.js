...
const hotelApi = {
  ...
  getAllRooms: () => axios.get('/rooms').then((r) => r.data),
  getRoomsByHotel: (hotelId) => axios.get(`/rooms/hotel/${hotelId}`).then((r) => r.data),
  ...
  addRoom: (payload) => axios.post('/rooms', payload).then((r) => r.data),
  updateRoom: (id, payload) => axios.put(`/rooms/${id}`, payload).then((r) => r.data),
  deleteRoom: (id) => axios.delete(`/rooms/${id}`).then((r) => r.data),
};
